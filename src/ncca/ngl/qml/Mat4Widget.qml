...
Frame {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            DecimalSpinBox {
                id: angleSpin
                visible: methodCombo.currentText !== "" && mat4Model.method_kind(methodCombo.currentText) === "angle"
                from_: -360.0
                to_: 360.0
                stepSize_: 0.5
                decimals: 1
            ...
            Vec3Widget {
                id: xyzWidget
                visible: methodCombo.currentText !== "" && mat4Model.method_kind(methodCombo.currentText) === "xyz"
                name: "xyz"
                xValue: 1.0
                yValue: 1.0
                zValue: 1.0
