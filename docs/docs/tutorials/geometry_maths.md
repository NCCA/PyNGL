# Geometry Maths — `BBox`, `Plane`, `BezierCurve`
...
smallest axis-aligned box the object fits inside. Collision detection,
picking, and view culling all test the cheap box before (or instead of)
the expensive mesh.

### Creating one

Two ways, matching how you usually have the data:
...
### The key operation — signed distance
